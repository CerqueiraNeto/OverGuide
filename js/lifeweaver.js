...
const endpoint = "https://overfast-api.tekrop.fr/heroes/lifeweaver";
...
const chapter4_title = document.getElementById("chapter4_title");
const chapter4_content = document.getElementById("chapter4_content");
const chapter4_picture = document.getElementById("chapter4_picture");

const chapter5_title = document.getElementById("chapter5_title");
const chapter5_content = document.getElementById("chapter5_content");
const chapter5_picture = document.getElementById("chapter5_picture");
...
const chapter4 = new Chapter(chapter4_title, chapter4_content, chapter4_picture);
const chapter5 = new Chapter(chapter5_title, chapter5_content, chapter5_picture);
...
const abilities = [weapon, ability1, ability2, ability3, ability4, ability5];
