...
const endpoint = "https://overfast-api.tekrop.fr/heroes/dva";
...
const ability4_name = document.getElementById("ability4_name");
const ability4_desc = document.getElementById("ability4_desc");
const ability4_icon = document.getElementById("ability4_icon");
const ability4_video = document.getElementById("ability4_video");

const ability5_name = document.getElementById("ability5_name");
const ability5_desc = document.getElementById("ability5_desc");
const ability5_icon = document.getElementById("ability5_icon");
const ability5_video = document.getElementById("ability5_video");

const ability6_name = document.getElementById("ability6_name");
const ability6_desc = document.getElementById("ability6_desc");
const ability6_icon = document.getElementById("ability6_icon");
const ability6_video = document.getElementById("ability6_video");

const ability7_name = document.getElementById("ability7_name");
const ability7_desc = document.getElementById("ability7_desc");
const ability7_icon = document.getElementById("ability7_icon");
const ability7_video = document.getElementById("ability7_video");
...
const ability4 = new Ability(ability4_name, ability4_desc, ability4_icon, ability4_video);
const ability5 = new Ability(ability5_name, ability5_desc, ability5_icon, ability5_video);
const ability6 = new Ability(ability6_name, ability6_desc, ability6_icon, ability6_video);
const ability7 = new Ability(ability7_name, ability7_desc, ability7_icon, ability7_video);

const abilities = [weapon, ability1, ability2, ability3, ability4, ability5, ability6, ability7];
